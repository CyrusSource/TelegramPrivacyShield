...
if (isset($update["callback_query"])) {
    ...
    if ($data === "help") {
        ...
        editMessageText(
            ...
            "👮 <b>ادمین‌ها:</b>\n" .
            "• ربات را ادمین کنید\n" .
            "• فقط دسترسی <b>حذف پیام‌ها</b> را فعال کنید",
            $keyboard
        );
    }
        ...
        if ($member["id"] == getBotId()) {
            ...
            if (($res["result"]["status"] ?? "") !== "administrator") {
                ...
                sendMessage($chat_id, "🛡 به گروه امن $groupTitle خوش آمدید!\n\n" .
                    ...
                    "• هیچ لاگ یا دسترسی به پیام شما ندارم.\n\n" .
                    "📌 ارسال پیام ناشناس:\n" .
                    ...
                    "• آیدی عددی گروه باید در دسترس باشد تا کاربر توانایی ارسال پیام به صورت امن را داشته باشد. این آیدی با ارسال پیام <code>/getChatID</code> در چت خصوصی شما در ربات دیده می‌شود.\n" .
...
foreach ($map as $key => $label) {
    if (isset($msg[$key])) {
        ...
        $caption = "📎 $label ارسال شده توسط <b>$name</b>";
